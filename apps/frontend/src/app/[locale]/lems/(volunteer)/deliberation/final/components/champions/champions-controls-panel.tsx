...
export const ChampionsControlsPanel: React.FC = () => {
  ...
  const isChampionsComplete = useMemo(
    () => (deliberation ? Object.keys(awards.champions).length > 0 : false),
    [deliberation, awards.champions]
  );
      ...
      <Box sx={{ display: 'flex', gap: 1, flexDirection: 'column' }}>
        {isNotStarted ? (
          ...
          <Button
            ...
            color="success"
            fullWidth
            disabled={!isChampionsComplete || isAdvancing}
            startIcon={isAdvancing ? undefined : <Verified />}
