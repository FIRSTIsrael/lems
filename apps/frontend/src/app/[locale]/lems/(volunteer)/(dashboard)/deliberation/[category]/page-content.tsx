...
interface CategoryDeliberationPageContentProps {
  category: string;
}

export default function CategoryDeliberationPageContent({
  category
}: CategoryDeliberationPageContentProps) {
                    ...
                    <>
                      ...
                      <Grid container spacing={2}>
                        ...
                        <Grid size={{ xs: 12, sm: 6 }}>
                          ...
                          <Chip
                            label={team.judgingSession.status || 'not-started'}
                            color={statusColor[team.judgingSession.status || 'not-started']}
                            variant="filled"
                            size="small"
                          />
                        </Grid>
