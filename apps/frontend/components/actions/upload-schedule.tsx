...
import { Button, ButtonProps, CircularProgress, Dialog, DialogActions, DialogContent, DialogContentText, DialogTitle, Input, Stack, Typography } from '@mui/material';
import ImportIcon from '@mui/icons-material/UploadRounded';
import FileIcon from '@mui/icons-material/AttachFile';
import { useSnackbar } from 'notistack';
import { ObjectId } from "mongodb";

interface UploadScheduleActionProps {
  eventId: ObjectId;
}

const UploadScheduleAction = ({ eventId, ...props }: UploadScheduleActionProps & ButtonProps) => {
...
export default UploadScheduleAction;
