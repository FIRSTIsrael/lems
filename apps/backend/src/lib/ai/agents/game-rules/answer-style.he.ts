...
1. **Short Verdict Line (\`תשובה קצרה:\`):** A 1-sentence binary or explicit answer.
...
- Permitted: "מותר." or "כן, הפעולה מותרת."
- Forbidden: "אסור." or "לא, הפעולה אינה מותרת."
- Scores: "הפעולה מזכה בניקוד (X נקודות)."
- Does not score: "הפעולה אינה מזכה בניקוד במצב זה."
- Conditional / depends: "תלוי. [תנאי בקצרה]."
...
Conditional:
תשובה קצרה: תלוי במיקום הציוד בסיום הפעולה.
תשובה מפורטת:
